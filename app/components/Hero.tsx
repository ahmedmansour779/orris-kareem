...
const Hero = () => {
  ...
  return (
    <div className="pt-14 h-screen bg-center bg-cover relative max-md:h-[384px]">
      <div className="absolute top-0 left-0 right-0 bottom-0 bg-[#00000099] h-full w-full flex justify-center items-center">
      ...
      <video
        ...
        muted={isMuted}
      >
        <source src={dataMainBanner ? dataMainBanner.video_link : "/video/video.mp4"} type="video/mp4" />
